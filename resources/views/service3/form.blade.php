...
<div class="box box-info" >
    <div class="box-header with-border">
        <div class="row">
            <div class="col-md-10"><h4 class="box-title"> @if($id>0) Edit Service 3 @else Form Tambah Service 3 @endif</h4></div>
        </div>
    </div>
    <div class="box-body">
...
<script type="text/javascript">
    ...
    $("#profile-id").change(function(){
     ...
     function SaveWarning(){
        ...
        a.icon          = $('#icon').val();      
        var url         = "{{route('service3_add') }}?id="+id+"&data="+'['+JSON.stringify(a)+']';
        AlertCheck('Apakah anda Yakin Menyimpan Data Ini?',url);
    }

    function back()
    {
        location.href="{{ route('service3_table') }}";
    }
