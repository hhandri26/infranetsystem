...
<div class="box box-info" >
    <div class="box-header with-border">
        <div class="row">
            <div class="col-md-10"><h4 class="box-title"> @if($id>0) Edit Service 1 @else Form Tambah Service 1  @endif</h4></div>
        </div>
    </div>
    <div class="box-body">
        <form id="form1" method="post" action="#" enctype="multipart/form-data" class="form-horizontal">
            <div class="panel panel-info">
               <div class="form-group" >
                   <label for="img" class="col-sm-3 control-label1">Gambar Service 1</label>
                        <div class="col-sm-9">
                ...
                <div class="panel panel-info">
                    <div class="panel-heading1"></div>     
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="title" class="col-sm-3 control-label1">Judul Service 1</label>
                                <div class="col-sm-9">
...
<script type="text/javascript">
     function SaveWarning(){
        ...
        var url         = "{{route('service1_add') }}?id="+id+"&data="+'['+JSON.stringify(a)+']';//url input data
        var obj_id      = 'profile-id';//nama id file input gambar/file
        var refresh     = 'service1_table';// url untuk reload page setelah input data
    ...
    function back()
    {
        location.href="{{ route('service1_table') }}";
    }
