...
<div class="box box-info" >
    <div class="box-header with-border">
        <div class="row">
            <div class="col-md-10"><h4 class="box-title">Form Tambah Materi @if($id>0) Edit Materi @endif</h4></div>
        </div>
    </div>
    <div class="box-body">
                    ...
                    <div class="panel-heading1"></div>     
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="id_menu" class="col-sm-6 control-label1">Katagori Materi</label>
                                <div class="col-sm-6">
