...
$test = DB::table('t_group_menu')->join('t_sub_menu','t_group_menu.id','=','t_sub_menu.id_group_menu')->select('t_group_menu.nama_menu','t_group_menu.level','t_group_menu.icon','t_sub_menu.nama','t_sub_menu.controller','t_sub_menu.method','t_sub_menu.id_group_menu')->get();
// var_dump($test);
// die();
//return $test;
                    ...
                    <div class="scrollbar-wrapper">
                        <div>
                            ...
                            <ul class="metisMenu nav" id="side-menu">
                                ...
                                <li>
                                    <a href="javascript: void(0);" aria-expanded="true"><i class="fa fa-users"></i> <?php echo $row->nama_menu?> <span class="fa arrow"></span></a>
